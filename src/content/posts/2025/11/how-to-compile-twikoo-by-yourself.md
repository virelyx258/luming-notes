...
date: 2025-11-06T18:38:00.000Z
lastMod: 2025-11-06T18:38:00.000Z
tags: [开发]
category: 科技
summary: '题同“如何自己编译 Twikoo”'
---
...
![动画](./how-to-compile-twikoo-by-yourself.assets/动画.gif)
...
```html
<a class="tk-action-link" href="javascript:void(0)" @click="onReply"></a>
```
...
```html
<a href="javascript:void(0)" v-if="comment.isSpam" @click="handleSpam(false, $event)"
  >{{ t('ADMIN_COMMENT_SHOW') }}</a
>
<a href="javascript:void(0)" v-if="!comment.isSpam" @click="handleSpam(true, $event)"
  >{{ t('ADMIN_COMMENT_HIDE') }}</a
>
<a href="javascript:void(0)" v-if="!comment.rid && comment.top" @click="handleTop(false, $event)"
  >{{ t('ADMIN_COMMENT_UNTOP') }}</a
>
<a href="javascript:void(0)" v-if="!comment.rid && !comment.top" @click="handleTop(true, $event)"
...
![{51A2745C-0173-45A0-9F86-0B5671E2AE9B}](./how-to-compile-twikoo-by-yourself.assets/{51A2745C-0173-45A0-9F86-0B5671E2AE9B}.png)
