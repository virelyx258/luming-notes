...
date: 2025-08-30T18:25:00.000Z
lastMod: 2025-08-30T18:25:00.000Z
tags: [Vela, 开发]
category: 科技
summary: 'Xiaomi Vela 应用程序开发教程。'
---
...
怎么办呢？很简单。我们只需要先将这个按钮以图片形式导出，再将它的 CSS 代码复制到 AIoT IDE 中，最后在程序中以`图片`的形式将其引入，即可完美实现所需的效果。_（在 Vela 系统中，图片可以绑定单击事件，所以自然可以当作按钮使用。）_
